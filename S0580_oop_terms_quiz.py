...
class Skyscraper(Building):  # class that inherits building

    def renovate(self):  # method that calls protected
...
for building in [small_house, skyscraper]:  # polymorhpism
